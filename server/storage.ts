...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    ...
    const playersData: Array<Omit<Player, 'id' | 'createdAt'>> = [
      ...
      { jerseyNumber: 5, firstName: "Mosh", lastName: "", position: "Midfielder", nationality: "Canada", dateOfBirth: "1990-08-15", height: "1.79m", joinDate: "2023-06-01", imageUrl: "/attached_assets/mosh-profile.png", isActive: true },
