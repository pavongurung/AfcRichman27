...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    ...
    const playersData: Array<Omit<Player, 'id' | 'createdAt'>> = [
      ...
      { jerseyNumber: 2, firstName: "Eddy", lastName: "", position: "Defender", nationality: "France", dateOfBirth: "1993-06-10", height: "1.82m", joinDate: "2021-08-20", imageUrl: "https://images.unsplash.com/photo-1529900748604-07564a03e7a6?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=600", isActive: true },
      { jerseyNumber: 3, firstName: "Bora", lastName: "", position: "Defender", nationality: "Serbia", dateOfBirth: "1991-12-05", height: "1.85m", joinDate: "2020-06-30", imageUrl: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=600", isActive: true },
      ...
      { jerseyNumber: 5, firstName: "Mosh", lastName: "", position: "Midfielder", nationality: "Canada", dateOfBirth: "1990-08-15", height: "1.79m", joinDate: "2023-06-01", imageUrl: "https://images.unsplash.com/photo-1553778263-73a83bab9b0c?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=600", isActive: true },
      ...
      { jerseyNumber: 7, firstName: "Jojo", lastName: "", position: "Forward", nationality: "Brazil", dateOfBirth: "1994-05-20", height: "1.77m", joinDate: "2021-06-15", imageUrl: "https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=600", isActive: true },
      ...
      { jerseyNumber: 9, firstName: "Salt", lastName: "", position: "Forward", nationality: "Netherlands", dateOfBirth: "1995-03-15", height: "1.83m", joinDate: "2022-07-01", imageUrl: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=600", isActive: true },
